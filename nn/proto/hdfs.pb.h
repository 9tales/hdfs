...
class BlockReportRequest : public ::google::protobuf::Message {
 public:
  ...
  inline const ::HDFS::DataNodeLocation& location() const;
  inline ::HDFS::DataNodeLocation* mutable_location();
  inline ::HDFS::DataNodeLocation* release_location();
  inline void set_allocated_location(::HDFS::DataNodeLocation* location);
 ...
 private:
  ...
  ::HDFS::DataNodeLocation* location_;
...
class WriteBlockRequest : public ::google::protobuf::Message {
 public:
  ...
  inline const ::HDFS::BlockLocations& blockinfo() const;
  inline ::HDFS::BlockLocations* mutable_blockinfo();
  inline ::HDFS::BlockLocations* release_blockinfo();
  inline void set_allocated_blockinfo(::HDFS::BlockLocations* blockinfo);
 ...
 private:
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::HDFS::BlockLocations* blockinfo_;
...
class DataNodeLocation : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:HDFS.DataNodeLocation)
 private:
...
class BlockLocations : public ::google::protobuf::Message {
 public:
  ...
  inline const ::HDFS::DataNodeLocation& locations(int index) const;
  inline ::HDFS::DataNodeLocation* mutable_locations(int index);
  inline ::HDFS::DataNodeLocation* add_locations();
  inline const ::google::protobuf::RepeatedPtrField< ::HDFS::DataNodeLocation >&
      locations() const;
  inline ::google::protobuf::RepeatedPtrField< ::HDFS::DataNodeLocation >*
      mutable_locations();

  // @@protoc_insertion_point(class_scope:HDFS.BlockLocations)
 private:
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::HDFS::DataNodeLocation > locations_;
...
class BlockLocationRequest : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:HDFS.BlockLocationRequest)
 private:
...
class BlockLocationResponse : public ::google::protobuf::Message {
 public:
  ...
  inline const ::HDFS::BlockLocations& blocklocations(int index) const;
  inline ::HDFS::BlockLocations* mutable_blocklocations(int index);
  inline ::HDFS::BlockLocations* add_blocklocations();
  inline const ::google::protobuf::RepeatedPtrField< ::HDFS::BlockLocations >&
      blocklocations() const;
  inline ::google::protobuf::RepeatedPtrField< ::HDFS::BlockLocations >*
      mutable_blocklocations();

  // @@protoc_insertion_point(class_scope:HDFS.BlockLocationResponse)
 private:
  inline void set_has_status();
  inline void clear_has_status();
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::HDFS::BlockLocations > blocklocations_;
  ::google::protobuf::int32 status_;
  friend void  protobuf_AddDesc_hdfs_2eproto();
  friend void protobuf_AssignDesc_hdfs_2eproto();
  friend void protobuf_ShutdownFile_hdfs_2eproto();
...
class AssignBlockResponse : public ::google::protobuf::Message {
 public:
  ...
  inline const ::HDFS::BlockLocations& newblock() const;
  inline ::HDFS::BlockLocations* mutable_newblock();
  inline ::HDFS::BlockLocations* release_newblock();
  inline void set_allocated_newblock(::HDFS::BlockLocations* newblock);
...
class ListFilesRequest : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:HDFS.ListFilesRequest)
 private:
...
class ListFilesResponse : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:HDFS.ListFilesResponse)
 private:
  inline void set_has_status();
  inline void clear_has_status();
...
class OpenFileResponse : public ::google::protobuf::Message {
 public:
  ...
  inline int blocknums_size() const;
  inline void clear_blocknums();
  static const int kBlockNumsFieldNumber = 3;
  inline ::google::protobuf::int32 blocknums(int index) const;
  inline void set_blocknums(int index, ::google::protobuf::int32 value);
  inline void add_blocknums(::google::protobuf::int32 value);
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
...
inline ::google::protobuf::int32 BlockReportRequest::id() const {
  // @@protoc_insertion_point(field_get:HDFS.BlockReportRequest.id)
  return id_;
}
inline void BlockReportRequest::set_id(::google::protobuf::int32 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:HDFS.BlockReportRequest.id)
}
...
inline const ::HDFS::DataNodeLocation& BlockReportRequest::location() const {
  // @@protoc_insertion_point(field_get:HDFS.BlockReportRequest.location)
  return location_ != NULL ? *location_ : *default_instance_->location_;
}
inline ::HDFS::DataNodeLocation* BlockReportRequest::mutable_location() {
  set_has_location();
  if (location_ == NULL) location_ = new ::HDFS::DataNodeLocation;
  // @@protoc_insertion_point(field_mutable:HDFS.BlockReportRequest.location)
  return location_;
}
inline ::HDFS::DataNodeLocation* BlockReportRequest::release_location() {
  clear_has_location();
  ::HDFS::DataNodeLocation* temp = location_;
  location_ = NULL;
  return temp;
}
inline void BlockReportRequest::set_allocated_location(::HDFS::DataNodeLocation* location) {
  delete location_;
  location_ = location;
  if (location) {
    set_has_location();
  ...
  // @@protoc_insertion_point(field_set_allocated:HDFS.BlockReportRequest.location)
}
...
inline ::google::protobuf::int32 BlockReportRequest::blocknumbers(int index) const {
  // @@protoc_insertion_point(field_get:HDFS.BlockReportRequest.blockNumbers)
...
inline void BlockReportRequest::set_blocknumbers(int index, ::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:HDFS.BlockReportRequest.blockNumbers)
}
inline void BlockReportRequest::add_blocknumbers(::google::protobuf::int32 value) {
  blocknumbers_.Add(value);
  // @@protoc_insertion_point(field_add:HDFS.BlockReportRequest.blockNumbers)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
BlockReportRequest::blocknumbers() const {
  // @@protoc_insertion_point(field_list:HDFS.BlockReportRequest.blockNumbers)
  return blocknumbers_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
BlockReportRequest::mutable_blocknumbers() {
  // @@protoc_insertion_point(field_mutable_list:HDFS.BlockReportRequest.blockNumbers)
  return &blocknumbers_;
}
...
inline ::google::protobuf::int32 BlockReportResponse::status(int index) const {
  // @@protoc_insertion_point(field_get:HDFS.BlockReportResponse.status)
  return status_.Get(index);
}
inline void BlockReportResponse::set_status(int index, ::google::protobuf::int32 value) {
  status_.Set(index, value);
  // @@protoc_insertion_point(field_set:HDFS.BlockReportResponse.status)
}
inline void BlockReportResponse::add_status(::google::protobuf::int32 value) {
  status_.Add(value);
  // @@protoc_insertion_point(field_add:HDFS.BlockReportResponse.status)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
BlockReportResponse::status() const {
  // @@protoc_insertion_point(field_list:HDFS.BlockReportResponse.status)
  return status_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
BlockReportResponse::mutable_status() {
  // @@protoc_insertion_point(field_mutable_list:HDFS.BlockReportResponse.status)
  return &status_;
}
...
inline ::google::protobuf::int32 HeartBeatRequest::id() const {
  // @@protoc_insertion_point(field_get:HDFS.HeartBeatRequest.id)
  return id_;
}
inline void HeartBeatRequest::set_id(::google::protobuf::int32 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:HDFS.HeartBeatRequest.id)
}
...
inline ::google::protobuf::int32 HeartBeatResponse::status() const {
  // @@protoc_insertion_point(field_get:HDFS.HeartBeatResponse.status)
  return status_;
}
inline void HeartBeatResponse::set_status(::google::protobuf::int32 value) {
  set_has_status();
  status_ = value;
  // @@protoc_insertion_point(field_set:HDFS.HeartBeatResponse.status)
}
...
inline const ::HDFS::BlockLocations& WriteBlockRequest::blockinfo() const {
  // @@protoc_insertion_point(field_get:HDFS.WriteBlockRequest.blockInfo)
  return blockinfo_ != NULL ? *blockinfo_ : *default_instance_->blockinfo_;
}
inline ::HDFS::BlockLocations* WriteBlockRequest::mutable_blockinfo() {
  set_has_blockinfo();
  if (blockinfo_ == NULL) blockinfo_ = new ::HDFS::BlockLocations;
  // @@protoc_insertion_point(field_mutable:HDFS.WriteBlockRequest.blockInfo)
  return blockinfo_;
}
inline ::HDFS::BlockLocations* WriteBlockRequest::release_blockinfo() {
  clear_has_blockinfo();
  ::HDFS::BlockLocations* temp = blockinfo_;
  blockinfo_ = NULL;
  return temp;
}
inline void WriteBlockRequest::set_allocated_blockinfo(::HDFS::BlockLocations* blockinfo) {
  delete blockinfo_;
  ...
  // @@protoc_insertion_point(field_set_allocated:HDFS.WriteBlockRequest.blockInfo)
}
...
inline const ::std::string& WriteBlockRequest::data(int index) const {
  // @@protoc_insertion_point(field_get:HDFS.WriteBlockRequest.data)
  return data_.Get(index);
}
inline ::std::string* WriteBlockRequest::mutable_data(int index) {
  // @@protoc_insertion_point(field_mutable:HDFS.WriteBlockRequest.data)
  return data_.Mutable(index);
}
inline void WriteBlockRequest::set_data(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:HDFS.WriteBlockRequest.data)
  data_.Mutable(index)->assign(value);
}
inline void WriteBlockRequest::set_data(int index, const char* value) {
  data_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:HDFS.WriteBlockRequest.data)
}
inline void WriteBlockRequest::set_data(int index, const void* value, size_t size) {
  data_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:HDFS.WriteBlockRequest.data)
}
...
inline void WriteBlockRequest::add_data(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:HDFS.WriteBlockRequest.data)
}
inline void WriteBlockRequest::add_data(const char* value) {
  data_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:HDFS.WriteBlockRequest.data)
}
inline void WriteBlockRequest::add_data(const void* value, size_t size) {
  data_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:HDFS.WriteBlockRequest.data)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
WriteBlockRequest::data() const {
  // @@protoc_insertion_point(field_list:HDFS.WriteBlockRequest.data)
  return data_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
WriteBlockRequest::mutable_data() {
  // @@protoc_insertion_point(field_mutable_list:HDFS.WriteBlockRequest.data)
  return &data_;
}
...
inline ::google::protobuf::int32 WriteBlockResponse::status() const {
  // @@protoc_insertion_point(field_get:HDFS.WriteBlockResponse.status)
  return status_;
}
inline void WriteBlockResponse::set_status(::google::protobuf::int32 value) {
  set_has_status();
  status_ = value;
  // @@protoc_insertion_point(field_set:HDFS.WriteBlockResponse.status)
}
...
inline ::google::protobuf::int32 CloseFileRequest::handle() const {
  // @@protoc_insertion_point(field_get:HDFS.CloseFileRequest.handle)
  return handle_;
}
inline void CloseFileRequest::set_handle(::google::protobuf::int32 value) {
  set_has_handle();
  handle_ = value;
  // @@protoc_insertion_point(field_set:HDFS.CloseFileRequest.handle)
}
...
inline ::google::protobuf::int32 CloseFileResponse::status() const {
  // @@protoc_insertion_point(field_get:HDFS.CloseFileResponse.status)
  return status_;
}
inline void CloseFileResponse::set_status(::google::protobuf::int32 value) {
  set_has_status();
  status_ = value;
  // @@protoc_insertion_point(field_set:HDFS.CloseFileResponse.status)
}
...
inline const ::std::string& DataNodeLocation::ip() const {
  // @@protoc_insertion_point(field_get:HDFS.DataNodeLocation.ip)
  return *ip_;
}
inline void DataNodeLocation::set_ip(const ::std::string& value) {
  ...
  ip_->assign(value);
  // @@protoc_insertion_point(field_set:HDFS.DataNodeLocation.ip)
}
inline void DataNodeLocation::set_ip(const char* value) {
  ...
  ip_->assign(value);
  // @@protoc_insertion_point(field_set_char:HDFS.DataNodeLocation.ip)
}
inline void DataNodeLocation::set_ip(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:HDFS.DataNodeLocation.ip)
}
inline ::std::string* DataNodeLocation::mutable_ip() {
  ...
  // @@protoc_insertion_point(field_mutable:HDFS.DataNodeLocation.ip)
  return ip_;
}
...
inline void DataNodeLocation::set_allocated_ip(::std::string* ip) {
  ...
  // @@protoc_insertion_point(field_set_allocated:HDFS.DataNodeLocation.ip)
}
...
inline ::google::protobuf::int32 DataNodeLocation::port() const {
  // @@protoc_insertion_point(field_get:HDFS.DataNodeLocation.port)
  return port_;
}
inline void DataNodeLocation::set_port(::google::protobuf::int32 value) {
  set_has_port();
  port_ = value;
  // @@protoc_insertion_point(field_set:HDFS.DataNodeLocation.port)
}
...
inline ::google::protobuf::int32 BlockLocations::blocknumber() const {
  // @@protoc_insertion_point(field_get:HDFS.BlockLocations.blockNumber)
  return blocknumber_;
}
inline void BlockLocations::set_blocknumber(::google::protobuf::int32 value) {
  set_has_blocknumber();
  blocknumber_ = value;
  // @@protoc_insertion_point(field_set:HDFS.BlockLocations.blockNumber)
}
...
inline const ::HDFS::DataNodeLocation& BlockLocations::locations(int index) const {
  // @@protoc_insertion_point(field_get:HDFS.BlockLocations.locations)
  return locations_.Get(index);
}
inline ::HDFS::DataNodeLocation* BlockLocations::mutable_locations(int index) {
  // @@protoc_insertion_point(field_mutable:HDFS.BlockLocations.locations)
  return locations_.Mutable(index);
}
inline ::HDFS::DataNodeLocation* BlockLocations::add_locations() {
  // @@protoc_insertion_point(field_add:HDFS.BlockLocations.locations)
  return locations_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::HDFS::DataNodeLocation >&
BlockLocations::locations() const {
  // @@protoc_insertion_point(field_list:HDFS.BlockLocations.locations)
  return locations_;
}
inline ::google::protobuf::RepeatedPtrField< ::HDFS::DataNodeLocation >*
BlockLocations::mutable_locations() {
  // @@protoc_insertion_point(field_mutable_list:HDFS.BlockLocations.locations)
  return &locations_;
}
...
inline ::google::protobuf::int32 BlockLocationRequest::blocknums(int index) const {
  // @@protoc_insertion_point(field_get:HDFS.BlockLocationRequest.blockNums)
...
inline void BlockLocationRequest::set_blocknums(int index, ::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:HDFS.BlockLocationRequest.blockNums)
}
inline void BlockLocationRequest::add_blocknums(::google::protobuf::int32 value) {
  blocknums_.Add(value);
  // @@protoc_insertion_point(field_add:HDFS.BlockLocationRequest.blockNums)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
BlockLocationRequest::blocknums() const {
  // @@protoc_insertion_point(field_list:HDFS.BlockLocationRequest.blockNums)
  return blocknums_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
BlockLocationRequest::mutable_blocknums() {
  // @@protoc_insertion_point(field_mutable_list:HDFS.BlockLocationRequest.blockNums)
  return &blocknums_;
}
...
inline ::google::protobuf::int32 BlockLocationResponse::status() const {
  // @@protoc_insertion_point(field_get:HDFS.BlockLocationResponse.status)
  return status_;
}
inline void BlockLocationResponse::set_status(::google::protobuf::int32 value) {
  set_has_status();
  status_ = value;
  // @@protoc_insertion_point(field_set:HDFS.BlockLocationResponse.status)
}
...
inline const ::HDFS::BlockLocations& BlockLocationResponse::blocklocations(int index) const {
  // @@protoc_insertion_point(field_get:HDFS.BlockLocationResponse.blockLocations)
  return blocklocations_.Get(index);
}
inline ::HDFS::BlockLocations* BlockLocationResponse::mutable_blocklocations(int index) {
  // @@protoc_insertion_point(field_mutable:HDFS.BlockLocationResponse.blockLocations)
  return blocklocations_.Mutable(index);
}
inline ::HDFS::BlockLocations* BlockLocationResponse::add_blocklocations() {
  // @@protoc_insertion_point(field_add:HDFS.BlockLocationResponse.blockLocations)
  return blocklocations_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::HDFS::BlockLocations >&
BlockLocationResponse::blocklocations() const {
  // @@protoc_insertion_point(field_list:HDFS.BlockLocationResponse.blockLocations)
  return blocklocations_;
}
inline ::google::protobuf::RepeatedPtrField< ::HDFS::BlockLocations >*
BlockLocationResponse::mutable_blocklocations() {
  // @@protoc_insertion_point(field_mutable_list:HDFS.BlockLocationResponse.blockLocations)
  return &blocklocations_;
}
...
inline ::google::protobuf::int32 AssignBlockRequest::handle() const {
  // @@protoc_insertion_point(field_get:HDFS.AssignBlockRequest.handle)
  return handle_;
}
inline void AssignBlockRequest::set_handle(::google::protobuf::int32 value) {
  set_has_handle();
  handle_ = value;
  // @@protoc_insertion_point(field_set:HDFS.AssignBlockRequest.handle)
}
...
inline ::google::protobuf::int32 AssignBlockResponse::status() const {
  // @@protoc_insertion_point(field_get:HDFS.AssignBlockResponse.status)
  return status_;
}
inline void AssignBlockResponse::set_status(::google::protobuf::int32 value) {
  set_has_status();
  status_ = value;
  // @@protoc_insertion_point(field_set:HDFS.AssignBlockResponse.status)
}
...
inline const ::HDFS::BlockLocations& AssignBlockResponse::newblock() const {
  // @@protoc_insertion_point(field_get:HDFS.AssignBlockResponse.newBlock)
  return newblock_ != NULL ? *newblock_ : *default_instance_->newblock_;
}
inline ::HDFS::BlockLocations* AssignBlockResponse::mutable_newblock() {
  set_has_newblock();
  if (newblock_ == NULL) newblock_ = new ::HDFS::BlockLocations;
  // @@protoc_insertion_point(field_mutable:HDFS.AssignBlockResponse.newBlock)
  return newblock_;
}
inline ::HDFS::BlockLocations* AssignBlockResponse::release_newblock() {
  clear_has_newblock();
  ::HDFS::BlockLocations* temp = newblock_;
  newblock_ = NULL;
  return temp;
}
inline void AssignBlockResponse::set_allocated_newblock(::HDFS::BlockLocations* newblock) {
  delete newblock_;
  newblock_ = newblock;
  if (newblock) {
    set_has_newblock();
  ...
  // @@protoc_insertion_point(field_set_allocated:HDFS.AssignBlockResponse.newBlock)
}
...
inline const ::std::string& ListFilesRequest::dirname() const {
  // @@protoc_insertion_point(field_get:HDFS.ListFilesRequest.dirName)
  return *dirname_;
}
inline void ListFilesRequest::set_dirname(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:HDFS.ListFilesRequest.dirName)
}
inline void ListFilesRequest::set_dirname(const char* value) {
  ...
  dirname_->assign(value);
  // @@protoc_insertion_point(field_set_char:HDFS.ListFilesRequest.dirName)
}
inline void ListFilesRequest::set_dirname(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:HDFS.ListFilesRequest.dirName)
}
inline ::std::string* ListFilesRequest::mutable_dirname() {
  ...
  // @@protoc_insertion_point(field_mutable:HDFS.ListFilesRequest.dirName)
  return dirname_;
}
...
inline void ListFilesRequest::set_allocated_dirname(::std::string* dirname) {
  ...
  // @@protoc_insertion_point(field_set_allocated:HDFS.ListFilesRequest.dirName)
}
...
inline ::google::protobuf::int32 ListFilesResponse::status() const {
  // @@protoc_insertion_point(field_get:HDFS.ListFilesResponse.status)
  return status_;
}
inline void ListFilesResponse::set_status(::google::protobuf::int32 value) {
  set_has_status();
  status_ = value;
  // @@protoc_insertion_point(field_set:HDFS.ListFilesResponse.status)
}
...
inline void ListFilesResponse::add_filenames(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:HDFS.ListFilesResponse.fileNames)
}
inline void ListFilesResponse::add_filenames(const char* value) {
  filenames_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:HDFS.ListFilesResponse.fileNames)
}
inline void ListFilesResponse::add_filenames(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:HDFS.ListFilesResponse.fileNames)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
ListFilesResponse::filenames() const {
  // @@protoc_insertion_point(field_list:HDFS.ListFilesResponse.fileNames)
  return filenames_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
ListFilesResponse::mutable_filenames() {
  // @@protoc_insertion_point(field_mutable_list:HDFS.ListFilesResponse.fileNames)
  return &filenames_;
}
...
inline const ::std::string& OpenFileRequest::filename() const {
  // @@protoc_insertion_point(field_get:HDFS.OpenFileRequest.fileName)
  return *filename_;
}
inline void OpenFileRequest::set_filename(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:HDFS.OpenFileRequest.fileName)
}
inline void OpenFileRequest::set_filename(const char* value) {
  ...
  filename_->assign(value);
  // @@protoc_insertion_point(field_set_char:HDFS.OpenFileRequest.fileName)
}
inline void OpenFileRequest::set_filename(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:HDFS.OpenFileRequest.fileName)
}
inline ::std::string* OpenFileRequest::mutable_filename() {
  ...
  // @@protoc_insertion_point(field_mutable:HDFS.OpenFileRequest.fileName)
  return filename_;
}
...
inline void OpenFileRequest::set_allocated_filename(::std::string* filename) {
  ...
  // @@protoc_insertion_point(field_set_allocated:HDFS.OpenFileRequest.fileName)
}
...
inline bool OpenFileRequest::forread() const {
  // @@protoc_insertion_point(field_get:HDFS.OpenFileRequest.forRead)
  return forread_;
}
inline void OpenFileRequest::set_forread(bool value) {
  set_has_forread();
  forread_ = value;
  // @@protoc_insertion_point(field_set:HDFS.OpenFileRequest.forRead)
}
...
inline ::google::protobuf::int32 OpenFileResponse::status() const {
  // @@protoc_insertion_point(field_get:HDFS.OpenFileResponse.status)
  return status_;
}
inline void OpenFileResponse::set_status(::google::protobuf::int32 value) {
  set_has_status();
  status_ = value;
  // @@protoc_insertion_point(field_set:HDFS.OpenFileResponse.status)
}
...
inline ::google::protobuf::int32 OpenFileResponse::handle() const {
  // @@protoc_insertion_point(field_get:HDFS.OpenFileResponse.handle)
  return handle_;
}
inline void OpenFileResponse::set_handle(::google::protobuf::int32 value) {
  set_has_handle();
  handle_ = value;
  // @@protoc_insertion_point(field_set:HDFS.OpenFileResponse.handle)
}

// repeated int32 blockNums = 3;
inline int OpenFileResponse::blocknums_size() const {
  return blocknums_.size();
}
inline void OpenFileResponse::clear_blocknums() {
  blocknums_.Clear();
}
inline ::google::protobuf::int32 OpenFileResponse::blocknums(int index) const {
  // @@protoc_insertion_point(field_get:HDFS.OpenFileResponse.blockNums)
  return blocknums_.Get(index);
}
inline void OpenFileResponse::set_blocknums(int index, ::google::protobuf::int32 value) {
  blocknums_.Set(index, value);
  // @@protoc_insertion_point(field_set:HDFS.OpenFileResponse.blockNums)
}
inline void OpenFileResponse::add_blocknums(::google::protobuf::int32 value) {
  blocknums_.Add(value);
  // @@protoc_insertion_point(field_add:HDFS.OpenFileResponse.blockNums)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
OpenFileResponse::blocknums() const {
  // @@protoc_insertion_point(field_list:HDFS.OpenFileResponse.blockNums)
  return blocknums_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
OpenFileResponse::mutable_blocknums() {
  // @@protoc_insertion_point(field_mutable_list:HDFS.OpenFileResponse.blockNums)
  return &blocknums_;
}
...
inline ::google::protobuf::int32 ReadBlockRequest::blocknumber() const {
  // @@protoc_insertion_point(field_get:HDFS.ReadBlockRequest.blockNumber)
  return blocknumber_;
}
inline void ReadBlockRequest::set_blocknumber(::google::protobuf::int32 value) {
  set_has_blocknumber();
  blocknumber_ = value;
  // @@protoc_insertion_point(field_set:HDFS.ReadBlockRequest.blockNumber)
}
...
inline ::google::protobuf::int32 ReadBlockResponse::status() const {
  // @@protoc_insertion_point(field_get:HDFS.ReadBlockResponse.status)
  return status_;
}
inline void ReadBlockResponse::set_status(::google::protobuf::int32 value) {
  set_has_status();
  status_ = value;
  // @@protoc_insertion_point(field_set:HDFS.ReadBlockResponse.status)
}
...
inline const ::std::string& ReadBlockResponse::data(int index) const {
  // @@protoc_insertion_point(field_get:HDFS.ReadBlockResponse.data)
  return data_.Get(index);
}
inline ::std::string* ReadBlockResponse::mutable_data(int index) {
  // @@protoc_insertion_point(field_mutable:HDFS.ReadBlockResponse.data)
  return data_.Mutable(index);
}
inline void ReadBlockResponse::set_data(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:HDFS.ReadBlockResponse.data)
  data_.Mutable(index)->assign(value);
}
inline void ReadBlockResponse::set_data(int index, const char* value) {
  data_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:HDFS.ReadBlockResponse.data)
}
inline void ReadBlockResponse::set_data(int index, const void* value, size_t size) {
  data_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:HDFS.ReadBlockResponse.data)
}
...
inline void ReadBlockResponse::add_data(const ::std::string& value) {
  data_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:HDFS.ReadBlockResponse.data)
}
inline void ReadBlockResponse::add_data(const char* value) {
  data_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:HDFS.ReadBlockResponse.data)
}
inline void ReadBlockResponse::add_data(const void* value, size_t size) {
  data_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:HDFS.ReadBlockResponse.data)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
ReadBlockResponse::data() const {
  // @@protoc_insertion_point(field_list:HDFS.ReadBlockResponse.data)
  return data_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
ReadBlockResponse::mutable_data() {
  // @@protoc_insertion_point(field_mutable_list:HDFS.ReadBlockResponse.data)
  return &data_;
}
